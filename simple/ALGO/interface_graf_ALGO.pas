Program test_interfaceu_graficznego_ALGO; 
(*
{Grafika podstawowa}
...
Function IsEvent: boolean;{Wynikiem funkcji jest wartoœæ logiczna prawda, jeœli od ostatniego wywo³ania procedury Zdarzenie zasz³o jakieœ zdarzenie (naciœniêcie klawisza klawiatury lub lewego przycisku myszy w obrêbie okna wyników), w przeciwnym przypadk


u fa³sz.}
Procedure Event(Var k, x, y: integer);{Za zdarzenie uwa¿a siê naciœniêcie klawisza na klawiaturze lub wciœniêcie lewego przycisku myszki w obrêbie okna wyników. Jeœli w momencie wywo³ania procedury zdarzenia jeszcze nie by³o, to program oczekuje zdarzeni
