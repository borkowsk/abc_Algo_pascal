...
procedure ObsługaZdarzeń(var uciek,pogon:gracz); 
{Obsluguje sterowanie za pomocą zdarzeń}
o pVar 
...
{Sprawdza czy uciekinier nie został złapany}
begin 
...
begin 
  ...
  Font(15,0,60);
  MoveTo(10,y);
  write('Uciekinier przetrwał ',wynik,' dzięsiątych sekundy');
end; 

{Główne zmienne programu}
var 
...
begin 
  moveto(0,MaxY+40);   
  writeln('Zasady gry:');
  writeln('Czerwony uciekinier sterowany strzalkami musi jak najdłużej ');
  writeln('wymykać się niebieskiemu zaganiaczowi sterowanemu myszką.');
  wynik:=0; 
  ...
  repeat 
    ObsługaZdarzeń(uciekacz,poganiacz); 
    GraczZnika(uciekacz); 
    RuchGracza(uciekacz); 
    GraczWchodzi(uciekacz); 
